...
a("Bắt đầu chửi !");
setTimeout(() => {a({body: "Địt con mẹ mày" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "Địt cụ mày nữa hiện hồn" + " " + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a("Đmm ra đây nào")} , 90000);
setTimeout(() => {a({body: "Rén cái lồn à" + " " + name, mentions: arraytag})}, 95000);
setTimeout(() => {a({body: "Bước ra đây dmm" + " " + name, mentions: arraytag})}, 100000);
setTimeout(() => {a({body: "Lồn má chửi súc vật mày mệt quá" + " " + name, mentions: arraytag})}, 105000);
setTimeout(() => {a("Đéo chửi mày nữa")} , 110000);
}